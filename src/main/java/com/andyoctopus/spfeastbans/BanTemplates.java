...
public final class BanTemplates {
    ...
    static {
        ...
        register("badname", "Badname", Arrays.asList(
                ...
                "&cFind out more: &b%RULES_URL%",
                "&7",
                "&cPlease change your Minecraft username before trying to join again.",
                "&cIf you believe your name has been falsely blocked, contact &b%APPEAL_URL%"
        ));
        ...
        register("security", "Security", Arrays.asList(
                ...
                "&7Find out more: &b&n%SECURITY_BLOCK_URL%",
                "&7",
                "&7Ban ID: &f#%banid%",
                "&7Sharing your Ban ID may affect the processing of your appeal!"
        ));
        ...
        register("chargeback", "Chargeback", Arrays.asList(
                "&cYou are permanently banned from this server!",
                "&7",
                "&7Reason: &r&fChargeback: for more info and appeal, pleace visit %SUPPORT_HOST%.",
                "&7Find out more: &b&n%APPEAL_URL%",
                "&7",
                "&7Ban ID: &f#%banid%",
                "&7Sharing your Ban ID may affect the processing of your appeal!"
        ...
        register("ytban", "YtBan", Arrays.asList(
                "&cYou are permanently banned from this server!",
                "&7",
                "&7Reason: &r&fPlease contact %CONTACT_EMAIL% for assistance.",
                "&7",
                "&7Ban ID: &f#%banid%",
                "&7Sharing your Ban ID may affect the processing of your appeal!"
        ));
        ...
        register("fraud", "Fraud", Arrays.asList(
                "&cYou are permanently banned from this server!",
                "&7",
                "&7Reason: &r&fFraud: Please visit %SUPPORT_HOST% for clarifications or questions.",
                "&7Find out more: &b&n%APPEAL_URL%",
                "&7",
                "&7Ban ID: &f#%banid%",
                "&7Sharing your Ban ID may affect the processing of your appeal!"
        ...
        register("acc_del", "acc_del", Arrays.asList(
                ...
                "&7Find out more: &b&n%SUPPORT_URL%",
                "&7",
                "&7Ban ID: &f#%banid%",
                "&7Sharing your Ban ID may affect the processing of your appeal!"
        ));
