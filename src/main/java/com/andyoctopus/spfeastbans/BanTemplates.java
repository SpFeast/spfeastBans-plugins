...
public final class BanTemplates {
    ...
    static {
        register("cheating", "Cheating", Arrays.asList(
                ...
                "&7Find out more: &b&nhttps://www.spfeast.cn/appeal",
                "&7",
                "&7Ban ID: &f#%banid%",
        ...
        register("badname", "Badname", Arrays.asList(
                ...
                "&cFind out more: &bhttps://www.spfeast.cn/rules",
                "&7",
                "&cPlease change your Minecraft username before trying to join again.",
                "&cIf you believe your name has been falsely blocked, contact &bhttps://www.spfeast.cn/appeal"
        ));
        ...
        register("security", "Security", Arrays.asList(
                ...
                "&7Find out more: &b&nhttps://www.spfeast.cn/security-block",
                "&7",
                "&7Ban ID: &f#%banid%",
                "&7Sharing your Ban ID may affect the processing of your appeal!"
        ));
        ...
        register("chargeback", "Chargeback", Arrays.asList(
                "&cYou are permanently banned from this server!",
                "&7",
                "&7Reason: &r&fChargeback: for more info and appeal, pleace visit support.spfeast.cn.",
                "&7Find out more: &b&nhttps://www.spfeast.cn/appeal",
                "&7",
                "&7Ban ID: &f#%banid%",
                "&7Sharing your Ban ID may affect the processing of your appeal!"
        ...
        register("ytban", "YtBan", Arrays.asList(
                "&cYou are permanently banned from this server!",
                "&7",
                "&7Reason: &r&fPlease contact spfeast@icloud.com for assistance.",
                "&7",
                "&7Ban ID: &f#%banid%",
                "&7Sharing your Ban ID may affect the processing of your appeal!"
        ));
        ...
        register("fraud", "Fraud", Arrays.asList(
                "&cYou are permanently banned from this server!",
                "&7",
                "&7Reason: &r&fFraud: Please visit support.spfeast.cn for clarifications or questions.",
                "&7Find out more: &b&nhttps://www.spfeast.cn/appeal",
                "&7",
                "&7Ban ID: &f#%banid%",
                "&7Sharing your Ban ID may affect the processing of your appeal!"
        ...
        register("acc_del", "acc_del", Arrays.asList(
                ...
                "&7Find out more: &b&nhttps://support.spfeast.cn",
                "&7",
                "&7Ban ID: &f#%banid%",
                "&7Sharing your Ban ID may affect the processing of your appeal!"
        ));
    ...
    public static BanTemplate get(String key) {
